...
drop table if exists sucursal_F2_HTBBDD_S2 cascade constraints;
create table sucursal_F2_HTBBDD_S2(
...
drop table if exists sucursal_venta_F2_HTBBDD_S2 cascade constraints;
create table sucursal_venta_F2_HTBBDD_S2(
    sucursal_id number(10,0) not null,
    hora_apertura time not null,
    hora_cierre time not null,
    constraint sucursal_venta_F2_HTBBDD_S2_pk primary key (sucursal_id),
    constraint sucursal_venta_F2_HTBBDD_S2_sucursal_id_fk foreign key (sucursal_id)
        references sucursal_F2_HTBBDD_S2(sucursal_id)
);

prompt creando el fragmento 2 de la tabla sucursal_taller
drop table if exists sucursal_taller_F2_HTBBDD_S2 cascade constraints;
create table sucursal_taller_F2_HTBBDD_S2(
    sucursal_id number(10,0) not null,
    dia_descanso number(1,0) not null,
    telefono_atencion varchar2(20) not null,
    constraint sucursal_taller_F2_HTBBDD_S2_pk primary key (sucursal_id),
    constraint sucursal_taller_F2_HTBBDD_S2_dia_descanso_chk check (dia_descanso between 1 and 7),
    constraint sucursal_taller_F2_HTBBDD_S2_sucursal_id_fk foreign key (sucursal_id)
        references sucursal_F2_HTBBDD_S2(sucursal_id)
);

prompt creando la el fragmento 2 de la tabla servicio_laptop
drop table if exists servicio_laptop_F2_HTBBDD_S2 cascade constraints;
create table servicio_laptop_F2_HTBBDD_S2(
    ...
    sucursal_id number(10,0) not null,
    constraint servicio_laptop_F2_HTBBDD_S2_pk primary key (laptop_id, num_servicio),
    constraint servicio_laptop_F2_HTBBDD_S2_sucursal_id_fk foreign key (sucursal_id)
        references sucursal_taller_F2_HTBBDD_S2(sucursal_id)
);

prompt creando el fragmento replicado 2 de la tabla tipo_procesador
drop table if exists tipo_procesador_R_HTBBDD_S2 cascade constraints;
create table tipo_procesador_R_HTBBDD_S2(
    tipo_procesador_id number(10,0) not null,
    clave varchar2(40) not null,
    descripcion varchar2(400) not null,
    constraint tipo_procesador_R_HTBBDD_S2_pk primary key (tipo_procesador_id)
);

prompt creando la secuencia para la tabla tipo_procesador del fragmento replicado 2
drop sequence if exists tipo_procesador_R_HTBBDD_S2_seq;
create sequence tipo_procesador_R_HTBBDD_S2_seq
    start with 1
    increment by 1
    nomaxvalue
    nocycle
...
drop table if exists tipo_tarjeta_video_R_HTBBDD_S2 cascade constraints;
create table tipo_tarjeta_video_R_HTBBDD_S2(
    tipo_tarjeta_video_id number(10,0) not null,
    clave varchar2(40) not null,
    descripcion varchar2(400) not null,
    constraint tipo_tarjeta_video_R_HTBBDD_S2_pk primary key (tipo_tarjeta_video_id)
);

prompt creando la secuencia para la tabla tipo_tarjeta_video del fragmento replicado 2
drop sequence if exists tipo_tarjeta_video_R_HTBBDD_S2_seq;
create sequence tipo_tarjeta_video_R_HTBBDD_S2_seq
    start with 1
    increment by 1
    nomaxvalue
    nocycle
...
drop table if exists tipo_almacenamiento_R_HTBBDD_S2 cascade constraints;
create table tipo_almacenamiento_R_HTBBDD_S2(
    tipo_almacenamiento_id number(10,0) not null,
    clave varchar2(40) not null,
    descripcion varchar2(400) not null,
    constraint tipo_almacenamiento_R_HTBBDD_S2_pk primary key (tipo_almacenamiento_id)
);

prompt creando la secuencia para la tabla tipo_almacenamiento del fragmento replicado 2
drop sequence if exists tipo_almacenamiento_R_HTBBDD_S2_seq;
create sequence tipo_almacenamiento_R_HTBBDD_S2_seq
    start with 1
    increment by 1
    nomaxvalue
    nocycle
...
drop table if exists tipo_monitor_R_HTBBDD_S2 cascade constraints;
create table tipo_monitor_R_HTBBDD_S2(
    tipo_monitor_id number(10,0) not null,
    clave varchar2(40) not null,
    descripcion varchar2(400) not null,
    constraint tipo_monitor_R_HTBBDD_S2_pk primary key (tipo_monitor_id)
);

prompt creando la secuencia para la tabla tipo_monitor del fragmento replicado 2
drop sequence if exists tipo_monitor_R_HTBBDD_S2_seq;
create sequence tipo_monitor_R_HTBBDD_S2_seq
    start with 1
    increment by 1
    nomaxvalue
    nocycle
...
drop table if exists historico_status_laptop_F1_HTBBDD_S2 cascade constraints;
create table historico_status_laptop_F1_HTBBDD_S2(
    historico_status_laptop_id number(10,0) not null,
    fecha_status date not null,
    laptop_id number(10,0) not null,
    status_laptop_id number(10,0) not null,
    constraint historico_status_laptop_F1_HTBBDD_S2_pk primary key (historico_status_laptop_id),
    constraint historico_status_laptop_F1_HTBBDD_S2_laptop_id_fk foreign key (laptop_id)
        references laptop_F1_HTBBDD_S2(laptop_id),
    constraint historico_status_laptop_F1_HTBBDD_S2_status_laptop_id_fk foreign key (status_laptop_id)
...
drop sequence if exists historico_status_laptop_F1_HTBBDD_S2_seq;
create sequence historico_status_laptop_F1_HTBBDD_S2_seq
    start with 1
    increment by 1
    nomaxvalue
    nocycle
