...
create table sucursal_F2_HTB_S2(
    ...
    constraint sucursal_F2_HTB_S2_es_taller_chk check (es_taller in (0, 1)),
    constraint sucursal_F2_HTB_S2_es_venta_chk check (es_venta in (0, 1)),
    constraint sucursal_F2_HTB_S2_tipo_sucursal_chk
