...
--@Descripción: Definicion del esquma de fragmentación para el sitio WS (LSI_s1)
-- y de sus respectivas secuencias

prompt creadno el fragmento 3 de la tabla sucursal
drop table if exists sucursal_F3_LSI_S1 cascade constraints;
create table sucursal_F3_LSI_S1(
    ...
    constraint sucursal_F3_LSI_S1_pk primary key (sucursal_id),
    constraint sucursal_F3_LSI_S1_uk_clave unique (clave),
    constraint sucursal_F3_LSI_S1_uk_url unique (url),
    constraint sucursal_F3_LSI_S1_tipo_sucursal_chk
...
create table sucursal_venta_F3_LSI_S1(
    ...
    constraint sucursal_venta_F3_LSI_S1_pk primary key (sucursal_id),
    constraint sucursal_venta_F3_LSI_S1_hora_apertura_chk check (hora_apertura between 0 and 1440),
    constraint sucursal_venta_F3_LSI_S1_hora_cierre_chk check (hora_cierre between 0 and 1440),
    constraint sucursal_venta_F3_LSI_S1_sucursal_id_fk foreign key (sucursal_id)
        references sucursal_F3_LSI_S1(sucursal_id)
);

prompt creando el fragmento 3 de la tabla sucursal_taller
drop table if exists sucursal_taller_F3_LSI_S1 cascade constraints;
create table sucursal_taller_F3_LSI_S1(
    sucursal_id number(10,0) not null,
    dia_descanso number(1,0) not null,
    telefono_atencion varchar2(20) not null,
    constraint sucursal_taller_F3_LSI_S1_pk primary key (sucursal_id),
    constraint sucursal_taller_F3_LSI_S1_telefono_atencion_uk unique (telefono_atencion),
    constraint sucursal_taller_F3_LSI_S1_dia_descanso_chk check (dia_descanso between 1 and 7),
    constraint sucursal_taller_F3_LSI_S1_sucursal_id_fk foreign key (sucursal_id)
        references sucursal_F3_LSI_S1(sucursal_id)
);

prompt creando el fragmento 3 de la tabla servicio_laptop
drop table if exists servicio_laptop_F3_LSI_S1 cascade constraints;
create table servicio_laptop_F3_LSI_S1(
    ...
    sucursal_id number(10,0) not null,
    constraint servicio_laptop_F3_LSI_S1_pk primary key (laptop_id, num_servicio),
    constraint servicio_laptop_F3_LSI_S1_importe_chk check (importe > 0),
    constraint servicio_laptop_F3_LSI_S1_sucursal_id_fk foreign key (sucursal_id)
...
create table tipo_almacenamiento_R_LSI_S1(
...
drop table if exists laptop_inventario_F1_LSI_S1 cascade constraints;
create table laptop_inventario_F1_LSI_S1(
    laptop_id number(10,0) not null,
    rfc_cliente varchar2(13) not null,
    num_tarjeta varchar2(16) not null,
    constraint laptop_inventario_F1_LSI_S1_pk primary key (laptop_id),
    constraint laptop_inventario_F1_LSI_S1_rfc_cliente_uk unique (rfc_cliente),
    constraint laptop_inventario_F1_LSI_S1_num_tarjeta_uk unique (num_tarjeta)
);

prompt creando el fragmento 4 de la tabla laptop
drop table if exists laptop_F4_LSI_S1 cascade constraints;
create table laptop_F4_LSI_S1(
    laptop_id number(10,0) not null,
    ...
    constraint laptop_F4_LSI_S1_pk primary key (laptop_id),
    constraint laptop_F4_LSI_S1_num_serie_uk unique (num_serie),
    constraint laptop_F4_LSI_S1_tipo_procesador_id_fk foreign key (tipo_procesador_id)
        references tipo_procesador_R_LSI_S1(tipo_procesador_id),
    constraint laptop_F4_LSI_S1_tipo_tarjeta_video_id_fk foreign key (tipo_tarjeta_video_id)
        references tipo_tarjeta_video_R_LSI_S1(tipo_tarjeta_video_id),
    constraint laptop_F4_LSI_S1_tipo_almacenamiento_id_fk foreign key (tipo_almacenamiento_id)
        references tipo_almacenamiento_R_LSI_S1(tipo_almacenamiento_id),
    constraint laptop_F4_LSI_S1_tipo_monitor_id_fk foreign key (tipo_monitor_id)
        references tipo_monitor_R_LSI_S1(tipo_monitor_id),
    constraint laptop_F4_LSI_S1_laptop_reemplazo_id_fk foreign key (laptop_reemplazo_id)
        references laptop_inventario_F1_LSI_S1(laptop_id)
);
