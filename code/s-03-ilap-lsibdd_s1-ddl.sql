...
drop table if exists sucursal_F1_LSI_S1 cascade constraints;
create table sucursal_F1_LSI_S1(
    ...
    constraint sucursal_F1_LSI_S1_pk primary key (sucursal_id)
);

prompt creando la secuencia para la tabla sucursal del fragmento 3
drop sequence if exists sucursal_F1_LSI_S1_seq;
create sequence sucursal_F1_LSI_S1_seq
    start with 1
    increment by 1
    nomaxvalue
    nocycle
...
drop table if exists sucursal_venta_F1_LSI_S1 cascade constraints;
create table sucursal_venta_F1_LSI_S1(
    sucursal_id number(10,0) not null,
    hora_apertura time not null,
    hora_cierre time not null,
    constraint sucursal_venta_F1_LSI_S1_pk primary key (sucursal_id),
    constraint sucursal_venta_F1_LSI_S1_sucursal_id_fk foreign key (sucursal_id)
        references sucursal_F1_LSI_S1(sucursal_id)
);

prompt creando el fragmento 3 de la tabla sucursal_taller
drop table if exists sucursal_taller_F1_LSI_S1 cascade constraints;
create table sucursal_taller_F1_LSI_S1(
    sucursal_id number(10,0) not null,
    dia_descanso number(1,0) not null,
    telefono_atencion varchar2(20) not null,
    constraint sucursal_taller_F1_LSI_S1_pk primary key (sucursal_id),
    constraint sucursal_taller_F1_LSI_S1_dia_descanso_chk check (dia_descanso between 1 and 7),
    constraint sucursal_taller_F1_LSI_S1_sucursal_id_fk foreign key (sucursal_id)
        references sucursal_F1_LSI_S1(sucursal_id)
);

prompt creando el fragmento 3 de la tabla servicio_laptop
drop table if exists servicio_laptop_F1_LSI_S1 cascade constraints;
create table servicio_laptop_F1_LSI_S1(
    ...
    sucursal_id number(10,0) not null,
    constraint servicio_laptop_F1_LSI_S1_pk primary key (laptop_id, num_servicio),
    constraint servicio_laptop_F1_LSI_S1_sucursal_id_fk foreign key (sucursal_id)
        references sucursal_taller_F1_LSI_S1(sucursal_id)
);
...
create table laptop_inventario_F1_LSI_S1(
    ...
    constraint laptop_inventario_F1_LSI_S1_laptop_id_fk foreign key (status_laptop_id)
...
create table laptop_F4_LSI_S1(
    ...
    constraint laptop_F4_LSI_S1_laptop_reemplazo_id_fk foreign key (laptop_reemplazo_id)
        references laptop_inventario_F4_LSI_S1(laptop_id)
);
