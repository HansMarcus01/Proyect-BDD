...
--@Descripcion: Creacion de sinonimos para transparencia de localizacion en HTBBDD_S2

clear screen
whenever sqlerror exit rollback;

prompt =====================================
prompt Creando sinonimos en htbbdd_s2
prompt =====================================
...
create or replace synonym sucursal_f2 for sucursal_F2_HTB_S2;
...
create or replace synonym sucursal_venta_f2 for sucursal_venta_F2_HTB_S2;
...
create or replace synonym sucursal_taller_f2 for sucursal_taller_F2_HTB_S2;
...
create or replace synonym servicio_laptop_f2 for servicio_laptop_F2_HTB_S2;
...
create or replace synonym laptop_f5 for laptop_F5_HTB_S2;

prompt Creando sinonimos de historico_status_laptop
create or replace synonym historico_status_laptop_f1 for historico_status_laptop_F1_HTB_S2;
...
create or replace synonym tipo_procesador_r1 for tipo_procesador_R_HTB_S2;
...
create or replace synonym tipo_tarjeta_video_r1 for tipo_tarjeta_video_R_HTB_S2;
...
create or replace synonym tipo_almacenamiento_r1 for tipo_almacenamiento_R_HTB_S2;
...
create or replace synonym tipo_monitor_r1 for tipo_monitor_R_HTB_S2;
